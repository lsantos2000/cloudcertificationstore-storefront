...
export default function ContactPage() {
  return <ContentPage eyebrow="CONTACT" title="How can we help?" intro="For purchase, download, or product questions, include enough detail for us to identify the guide and order involved.">
